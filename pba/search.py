...
def main(_):
    ...
    """
        new_params = []
        if config["explore"] == "cifar10" or config["explore"] == "cifar100":
    ...
    # configs for distribution computations
    ray.init()
...
if __name__ == "__main__":
    import logging
    # tf.logging.log.basicConfig(filename='tensorflow.log', level=logging.info)
